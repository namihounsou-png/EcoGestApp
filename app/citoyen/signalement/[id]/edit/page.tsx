...
export default function EditSignalementPage() {
  ...
  // Récupération du signalement côté client uniquement
  useEffect(() => {
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
          ...
          <Card className="p-6">
            ...
            <div
              ...
              className="relative h-64 bg-secondary-200 rounded-lg flex items-center justify-center cursor-pointer overflow-hidden"
            >
          ...
          <Card className="p-6">
            <label htmlFor="description" className="block text-sm font-medium text-secondary-700 mb-3">
              Description
            </label>
            <textarea
              id="description"
